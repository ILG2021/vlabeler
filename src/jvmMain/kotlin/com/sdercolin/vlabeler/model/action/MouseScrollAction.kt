...
enum class MouseScrollAction(
    ...
    ScrollLeftCanvas(Strings.ActionScrollCanvasLeft, KeySet(Key.MouseScrollUp, setOf(Key.Shift))),
    ScrollRightCanvas(Strings.ActionScrollCanvasRight, KeySet(Key.MouseScrollDown, setOf(Key.Shift))),
    ;
